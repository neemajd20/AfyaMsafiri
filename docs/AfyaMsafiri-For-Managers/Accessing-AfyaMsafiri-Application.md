...
![alt text](<../../static/img/manager login.png>)
...
![alt text](<../../static/img/afyamsafiri application.png>)

[Landing Page for manager – Replace with the arrival dashboard]
![alt text](<../../static/img/landing page for manager.png>)
...
![alt text](<../../static/img/highlight on arrival & departure.png>)

[Displayed list of travelers]
![alt text](<../../static/img/displayed list of travelers.png>)
...
![alt text](<../../static/img/filters to access travelers info..png>)

[List of travelers]
![alt text](<../../static/img/list of travelers.png>)
